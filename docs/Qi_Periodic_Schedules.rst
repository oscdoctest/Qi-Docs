...
The API calls in this section are all used to create, delete, and manage periodic schedules into a namespace. Schedules can be referenced by calculations. 
